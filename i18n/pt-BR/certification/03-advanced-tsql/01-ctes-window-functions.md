...
**[↑ Voltar para a Seção](./advanced-tsql.md) | [Lab: CTEs e Window Functions](../../practice/labs/03-advanced-tsql/01-ctes-window-functions-lab.sql) | [Próximo →](./02-json-functions.md)**
